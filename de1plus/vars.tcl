...
proc select_profile { profile } {
	...
	set ::settings(warnings_enabled) 0
	set ::settings(warnings_time_lower) 15
	set ::settings(warnings_time_seconds_upper) 30
